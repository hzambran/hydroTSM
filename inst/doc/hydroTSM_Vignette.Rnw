...
\title{Tutorial for Introductory Analysis of \\
       Daily Precipitation Data with R}
\date{Oct 2010}
...
\item Packages required by the \textit{hydroTSM} library:

<<eval=FALSE>>=
install.packages(c("zoo", "gstat", "automap"))
@

\item Packages suggested by the \textit{hydroTSM} library:

<<eval=FALSE>>=
install.packages(c("Hmisc", "e1071", "sp", "maptools", "rgdal"))
@

\item \textit{hydroTSM} library:

<<eval=FALSE>>=
install.packages(c("hydroTSM"))
@
