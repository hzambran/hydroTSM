...
If you use *[hydroTSM](https://CRAN.R-project.org/package=hydroTSM)*, please cite it as Zambrano-Bigiarini (2025):

Zambrano-Bigiarini, Mauricio (2025). hydroTSM: Time Series Management and Analysis for Hydrological Modelling. R package version 0.8-0. URL:https://CRAN.R-project.org/package=hydroTSM. doi:10.32614/CRAN.package.hydroTSM.
...
*  **Multi-platform**: [Sublime Text](https://www.sublimetext.com/) (https://sublime.weberup.com/) ; [RStudio](https://posit.co/) (https://posit.co/)
...
*  [**some examples**](https://www.datacamp.com/doc/r/importingdata): https://www.datacamp.com/doc/r/importingdata



## Useful Websites

*  [**Quick R**](https://www.datacamp.com/doc/r/category/r-documentation): https://www.datacamp.com/doc/r/category/r-documentation
