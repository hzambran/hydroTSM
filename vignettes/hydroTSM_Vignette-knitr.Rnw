...
\date{Last Update: 07-Aug-2017}
%\date{Aug 2017, May 2013, Aug 2011, Apr 2011, Oct 2010,  30-May-2013}
...
\noindent Alternatively, you can also try the under-development version (from  \href{https://github.com/hzambran/hydroTSM}{Github}):
...
\begin{center}
<<hydroplot, dev='pdf', dev='postscript', fig.width=10, fig.height=8>>=
