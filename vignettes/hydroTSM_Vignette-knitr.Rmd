...
```{r climograph, fig.width = 9, fig.height = 8, , dpi=100, fig.align = "center", dev.args=list(pointsize = 9)}
...
*  GNU/Linux only: [ESS](http://ess.r-project.org/)

*  Windows only  : [NppToR](http://sourceforge.net/projects/npptor/)

*  Multi-platform: [Sublime Text](https://sublime.weberup.com/) ; [RStudio](http://www.rstudio.com/)
