---
title: Tutorial for Introductory Analysis of Daily Precipitation Data with `hydroTSM`
author:
- Mauricio Zambrano-Bigiarini^[mauricio.zambrano@ufrontera.cl]
date: " version 0.8, 30-Nov-2023"
output:
  pdf_document:
    number_sections: yes
  html_document:
...
*  Global view of daily precipitation values a calendar heatmap (six years maximum):
...
*  **Multi-platform**: [Sublime Text](https://sublime.weberup.com/) (https://sublime.weberup.com/) ; [RStudio](https://www.rstudio.com/) (https://www.rstudio.com/)
...
*  [**some examples**](https://www.statmethods.net/input/importingdata.html): https://www.statmethods.net/input/importingdata.html
...
*  [**Time series in R**](https://cran.r-project.org/web/views/TimeSeries.html): https://cran.r-project.org/web/views/TimeSeries.html

*  [**Quick reference for the `zoo` package**](https://cran.r-project.org/web/packages/zoo/vignettes/zoo-quickref.pdf): https://cran.r-project.org/web/packages/zoo/vignettes/zoo-quickref.pdf


## F.A.Q.

# How to print more than one `matrixplot` in a single Figure?
Beacuase `matrixplot` is based on lattice graphs, normal plotting commands included in base R does not work. 
Therefore, for plotting ore than 1 matrixplot ina single figure, you need to save the individual plots in an R object and then print them as you want.

Int he following sequential lines of code, you can see two examples that show you how to plot two matrixplots in a single Figure:
...
```{r FAQmatrixplot2, fig.width = 8, fig.height = 7, , dpi=100, fig.align = "center", dev.args=list(pointsize = 9), eval=FALSE}
