...
According to the seasonality index defined by Walsh and Lawler (1981), a value of 0.39 corresponds to a precipitation regime that can be classified as "Equable but with a definite wetter season" (see more details with `?si`).
