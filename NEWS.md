...
## User-visible changes
        ...
        o 'extract' now handles numeric month vectors explicitly, including vectors that span the end of the calendar year such as c(9,10,11,12,1,2,3), and rejects mixed month/year numeric vectors.
